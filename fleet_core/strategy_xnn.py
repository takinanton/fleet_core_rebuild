...
def scan_for_signal(
    ...
    coin: str,
    tf: str,
    zigzag_length: int,               # uk knob — param renamed; value IGNORED (N forced to DONCHIAN_N=15)
    ...
    if tf not in DONCHIAN_TFS:
        return None
    n = DONCHIAN_N  # FORCE: ignore zigzag_length kwarg (Nado scanner passes zigzag_raw_length=5 which would wrongly set N=5)
